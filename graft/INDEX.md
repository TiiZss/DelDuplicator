...
- [delduplicator](delduplicator.md) — delduplicator
- [delduplicator_gui](delduplicator_gui.md) — delduplicator_gui
- [restore](restore.md) — restore

## Files

3 per-file wiring cards mirror the source tree under `graft/` (3 carry extracted symbols). They are deliberately not enumerated here —
